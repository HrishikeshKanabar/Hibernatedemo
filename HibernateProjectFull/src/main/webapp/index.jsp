...
<body>
  ...
  <h1 class="text-center heading"> Course Managment Portal </h1>
   ...
   <h3 class="text-center"> Student Dashboard </h3>
	  ...
	  <button type="button" class="btn btn-secondary">Get all Students</button>
	  </center>
    ...
    <h3 class="text-center">Instructor Dashboard</h3>
	   ...
	   <button type="button" class="btn btn-secondary">Get all Instructors</button>
	   </center>
    ...
    <h3 class="text-center">Course Dashboard</h3>
	   ...
	   <button type="button" class="btn btn-secondary">Get all Courses </button>
	   </center>
